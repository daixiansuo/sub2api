...
- Claude Opus 5 support for Kiro (`claude-opus-5`), with a 1M token context window, 128k max output tokens, and thinking enabled by default.
...
> [Want to appear here?](mailto:nianzs@kunstack.com)
