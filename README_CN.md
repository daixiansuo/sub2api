...
- Kiro 支持 Claude Opus 5（`claude-opus-5`）：1M token 上下文窗口、128k 最大输出 token，默认开启 thinking。
...
> [想出现在这里？](mailto:nianzs@kunstack.com)
...
<td>特别感谢 FlyMux 赞助本项目！FlyMux 致力于为 Claude Code 和 Codex 提供官方、高稳定性的中转服务，专注为开发者打造顺畅、高效的接入体验。作为 TinyRDM 用户专属福利，通过<a href="https://flymux.com/register?promo=TINYRDM">此链接</a>注册即可自动获得 $5 赠送额度。</td>
</tr>
